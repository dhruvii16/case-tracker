...
urlpatterns = [
    ...
    path('lawyer_store_super', views.lawyer_store_super, name='lawyer_store_super'),#for add superuser (Lawyer)
    path('client_list', views.client_list, name='client_list'),
    path('lawyer_list', views.lawyer_list, name='lawyer_list'),
    path('delete_client/<int:client_id>/', views.delete_client, name='delete_client'),
    path('delete_lawyer/<int:lawyer_id>/', views.delete_lawyer, name='delete_lawyer'),
]
